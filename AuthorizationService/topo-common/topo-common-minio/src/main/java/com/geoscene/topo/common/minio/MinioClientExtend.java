package com.geoscene.topo.common.minio;
 ...
 * }</pre>
 */
public class MinioClientExtend {
    private io.minio.MinioAsyncClient asyncClient = null;

    private MinioClientExtend(io.minio.MinioAsyncClient asyncClient) {
        this.asyncClient = asyncClient;
    }

    protected MinioClientExtend(MinioClientExtend client) {
    ...
    /** Argument builder of {@link MinioClientExtend}. */
    public static final class Builder {
        private io.minio.MinioAsyncClient.Builder asyncClientBuilder = null;

        public Builder() {
            asyncClientBuilder = io.minio.MinioAsyncClient.builder();
        }
        ...
        public MinioClientExtend build() {
            MinioAsyncClient asyncClient = asyncClientBuilder.build();
            return new MinioClientExtend(asyncClient);
        }
    }
}
