...
namespace XRMultiplayer
{
    ...
    public class PlayerAppearanceMenu : MonoBehaviour
    {
        ...
        // Propagates changes to username throughout scene.
        public void UpdateUIPlayerName()
        {
            // collect the username as it is written
            string name = m_PlayerNameInputField.text;

            // apply default value if empty
            if (name == string.Empty){
                m_PlayerNameInputField.text = "";
                XRINetworkGameManager.LocalPlayerName.Value = "Player";
                return;
            }

            // set username to selected name or default.
